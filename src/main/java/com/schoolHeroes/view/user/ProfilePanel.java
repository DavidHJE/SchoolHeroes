		...
		editButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (lastNameField.getText().trim().equals("")) {
					JOptionPane.showMessageDialog(ProfilePanel.this, "Le nom ne doit pas être vide !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}

				if (firstNameField.getText().trim().equals("")) {
					JOptionPane.showMessageDialog(ProfilePanel.this, "Le prénom ne doit pas être vide !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int response = JOptionPane.showOptionDialog(ProfilePanel.this,
						"Voulez vous vraiment suprimer ce compte ?", "Supprimer ce compte", JOptionPane.YES_NO_OPTION,
