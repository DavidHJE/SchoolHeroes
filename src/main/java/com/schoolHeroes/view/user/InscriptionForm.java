package com.schoolHeroes.view.user;
...
import com.schoolHeroes.view.MainForm;
		...
		inscriptionButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (usernameField.getText().trim().equals("")) {
					JOptionPane.showMessageDialog(contentPane, "Le nom d'utilisateur ne doit pas être vide !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}

				if (lastNameField.getText().trim().equals("")) {
					JOptionPane.showMessageDialog(contentPane, "Le nom ne doit pas être vide !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}

				if (firstNameField.getText().trim().equals("")) {
					JOptionPane.showMessageDialog(contentPane, "Le prénom ne doit pas être vide !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}

				if (passwordField.getPassword().length == 0 || passwordConfirmField.getPassword().length == 0) {
					JOptionPane.showMessageDialog(contentPane, "Le mot de passe ne doit pas être vide !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				...
				if (isUsernameUnique == false) {
					JOptionPane.showMessageDialog(contentPane, "Veuillez choisir un autre nom d'utilisateur", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				...
				try {
					...
					JOptionPane.showMessageDialog(contentPane,
							"Impossible de hasher le mot de passe ! Veuillez Reésayer !", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
